...
export declare function getAverageClient(clients: Client[]): {
    clientX: number;
    clientY: number;
};
export declare function getAddClient(client1: Client, client2: Client): {
    clientX: number;
    clientY: number;
};
export declare function getMinusClient(client1: Client, client2: Client): {
    clientX: number;
    clientY: number;
};
